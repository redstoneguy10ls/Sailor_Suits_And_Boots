...
public enum ModArmorMaterials implements ArmorMaterial {
    BLACK_BRONZE_CROWN("black_bronze_crown",26, new int[]{5, 7, 5, 4}, 25,
            SoundEvents.ARMOR_EQUIP_IRON, 1f, 0f, () -> Ingredient.of(Items.BLACK_CARPET));
